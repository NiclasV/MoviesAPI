...
const TmdbLogo = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="tmdb-logo" viewBox="0 0 185.04 133.4">
      <defs>
    ...
    return (
        <StyledFooter>
            <Container $variant="wide" $justify="flex-end">
                <Container>
                    <p style={{ margin: "10px 0px 0px 0px", fontSize: "14px" }}>Made with The Movie Database</p>
                    <TmdbLogo/>
                </Container>
